...
const ProjectCard = ({ title, subtitle, description, imageUrl }: ProjectCardProps) => {
  return (
    <div className="w-full mb-12 md:mb-16">
      <div className="flex flex-col lg:flex-row lg:h-[300px] border border-border rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-black/5 hover:-translate-y-1 cursor-pointer group overflow-hidden">
